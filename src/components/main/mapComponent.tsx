...
const MapComponent = () => {
    return (
        <div className="w-full h-screen flex justify-center items-center">
            <div className="relative w-[1200px] h-[514px] flex flex-col justify-center items-center gap-[30px] overflow-hidden">
                <div 
                    className="absolute inset-0 bg-[url('/worldmap.png')] bg-cover bg-center bg-no-repeat opacity-30 -z-10"
                ></div>
                <div className="w-[255px]  font-manrope md:text-[48px] text-[28px] font-semibold text-center leading-tight">
