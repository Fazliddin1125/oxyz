    ...
    return (
        <div className="p-[20px]" >
            <div className=" navbar  flex justify-between items-center">
                <div className="logo w-[160px] h-[40px]">
                ...
                <div className="nav-links flex justify-center gap-[5px] ">
                    ...
                    <div className="w-[50px] bg-[#FFFFFF33] rounded-[8px] hidden md:flex justify-center items-center h-[50px]">
                    ...
                    <div className="text-manrope font-normal w-[114px] bg-[#FFFFFF] text-[#1A1A18] gap-[5px] rounded-[8px] flex justify-center items-center h-[50px]">
